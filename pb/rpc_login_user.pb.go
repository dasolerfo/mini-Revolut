...
type LoginUserResponse struct {
	...
	AccessTokenExp  *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=access_token_exp,json=accessTokenExp,proto3" json:"access_token_exp,omitempty"`
	RefreshTokenExp *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refresh_token_exp,json=refreshTokenExp,proto3" json:"refresh_token_exp,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *LoginUserResponse) GetAccessTokenExp() *timestamppb.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExp() *timestamppb.Timestamp {
	if x != nil {
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xa6\x02\n" +
	...
	"\x10access_token_exp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0eaccessTokenExp\x12F\n" +
	"\x11refresh_token_exp\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0frefreshTokenExpB\x0fZ\rsimplebank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.LoginUserResponse.access_token_exp:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserResponse.refresh_token_exp:type_name -> google.protobuf.Timestamp
