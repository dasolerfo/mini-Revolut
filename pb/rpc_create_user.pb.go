...
type CreateUserRequest struct {
	...
	BornAt        string                 `protobuf:"bytes,7,opt,name=born_at,json=bornAt,proto3" json:"born_at,omitempty"`
...
func (x *CreateUserRequest) GetFirstSurname() string {
	if x != nil {
...
func (x *CreateUserRequest) GetSecondSurname() string {
	if x != nil {
...
func (x *CreateUserRequest) GetNationality() int32 {
	if x != nil {
...
func (x *CreateUserRequest) GetBornAt() string {
	if x != nil {
		return x.BornAt
	}
	return ""
...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"\vnationality\x18\x05 \x01(\x05R\vnationality\x12\x1a\n" +
	"\bpassword\x18\x06 \x01(\tR\bpassword\x12\x17\n" +
	"\aborn_at\x18\a \x01(\tR\x06bornAt\"2\n" +
